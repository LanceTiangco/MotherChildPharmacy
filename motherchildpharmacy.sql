...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2024 at 02:04 PM
...
(20, 'Two Pangalawa', 'PA', '2P', 'eztwo', '../resources/profile_icon.png', '2024-09-06 21:39:37', 'Inactive'),
...
CREATE TABLE `sales` (
  ...
  `ItemsQuantity` varchar(255) DEFAULT NULL,
  `ItemsID` text DEFAULT NULL,
  `TotalItems` int(11) NOT NULL,
  `ItemsReturnedQuantity` varchar(255) DEFAULT NULL,
  `ItemsReturnedID` text DEFAULT NULL,
  `TotalItemsReturned` int(11) DEFAULT NULL,
